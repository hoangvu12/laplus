        ...
        {runningActions ? (
          <>
            <Button
              ...
              variant="outline"
              disabled={
                !runningActions.canSteer || isSendBusy || isConnecting || isEnvironmentUnavailable
              }
              onClick={runningActions.onSteer}
              title="Guide the active turn now; text only"
            >
              Steer
            </Button>
            <Button
              ...
              size="sm"
              disabled={
                !hasSendableContent || isSendBusy || isConnecting || isEnvironmentUnavailable
              }
              title="Send a follow-up after the active turn"
            >
              Queue follow-up
            </Button>
          </>
