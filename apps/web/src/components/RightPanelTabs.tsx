...
const SURFACE_DISABLED_REASONS = {
  browser: "Browser previews are only available in the laplus desktop app.",
  ...
  return (
    ...
    >
      <div
        ...
        // Bare rather than "deep": a tab is a <div> with its own mousedown, not
        // a <button>, so Tauri's drag script would not stop at one. Only clicks
        // that land on this bar's own background drag the window.
