//! Walking a directory, once, for the two things here that need to.
...
///
/// Directories are descended into and never visited themselves — both callers
/// want files. An error reading any directory stops the walk and is
