...
//!
//! Ticket 23 makes lightcode a desktop application, and the first question a
...
//! bytes; the real 17 MB of `t3code/apps/web/dist` is a static table generated
//! in `lightcode-shell`'s build script and handed in at startup. A server crate
