...
| `add-remote-environment.mjs` | The same, through the real Settings form rather than `fetch`. **Exits 1 until ticket 06 lands** — its header says why that is a pending acceptance check and not a broken driver    |
