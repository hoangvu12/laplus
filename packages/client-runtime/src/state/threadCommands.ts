...
import {
  ...
  type RejectThreadUserInputInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    rejectUserInput: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:reject-user-input",
      execute: (input: RejectThreadUserInputInput) => rejectThreadUserInput(input),
      scheduler,
      concurrency,
    }),
